        ...
        <div class="backupCont_box" id="receiveAddressBtn">
          ...
          <div class="backupCont_input">
            ...
            <input
              ...
              style="opacity: 0;"
            >
            <div class="eyesBox showAndHideEyes" id="eyesView">
              <div class="eyes">
                <img src="@/assets/image/Visible.svg">
              </div>
            </div>
          </div>
          <button
            class="btn"
            @click="copyAddress('privateKeyInfo', 'receiveAddressBtn')"
            data-toggle="tooltip"
        ...
        <ul>
          ...
          <li>
            <div class="qrcodeView_cont">
              ...
              <div class="qrcodeView_eyes showAndHideEyes">
                <img src="@/assets/image/Visible.svg">
              </div>
            </div>
          </li>
  ...
  mounted() {
    ...
    $(".showAndHideEyes").click(() => {
      ...
      if (pwdAndTxt === "password") {
        ...
        $("#eyesView")
          .find("img")
          .attr("src", require("@/assets/image/Hide.svg"));
        ...
        $("#eyesView")
          .find("img")
          .attr("src", require("@/assets/image/Visible.svg"));
        $(".qrcodeView_eyes")
          .find("img")
          .attr("src", require("@/assets/image/Visible.svg"));
