  ...
  methods: {
    ...
    inputFileBtn () {
      ...
      try{
        ...
        that.publicKey = walletData.getPublicKeyString()
        ...
        that.$$.layerMsg(e, 2000, '#ea4b40', require('../../../../assets/image/Prompt.svg'))
        // that.showPwdBtn = false
      }
    },
    inputPwdBtn () {
      ...
      try {
        ...
        that.downloadName = ''
        that.goBackupWallet()
        // console.log(that.walletData.toV3(that.privateKey, {kdf: "scrypt", n: 8192}))
        // let walletJSON = that.walletData.toV3(that.password, {kdf: "scrypt", n: 8192})
        // that.downloadURLL = that.$$.getBlob('text/json;charset=UTF-8', walletJSON)
        // that.downloadName = that.walletData.getV3Filename()
      } catch (e) {
        that.$$.layerMsg(e, 2000, '#ea4b40', require('../../../../assets/image/Prompt.svg'))
        // that.showPwdBtn = false
      }
