<template>
  <div class="boxContent" id="app">
    <header class="headerTop_box flex-bc">
      <div class="logo flex-c"><router-link to="/" class="logoImg flex-c"><img src="@etc/img/logo.svg"></router-link></div>
      <div id="topSearchView">
        <div class="flex-ec">
...
export default {
  ...
  mounted () {
    ...
    this.language = localStorage.getItem('WALLET_LANGUAGE_TYPE') ? localStorage.getItem('WALLET_LANGUAGE_TYPE') : 'en'
  },
  methods: {
    reload() {
    ...
    changLanguage () {
      localStorage.setItem('WALLET_LANGUAGE_TYPE', this.language)
