      ...
      children: [
        {
          path: "/",
          component: resolve =>
            require(["@/components/web/page/createWallet/index"], resolve) // biticonView
        },
        {
          path: "/biticonView",
          name: "biticonView",
        ...
        },
        {
          ...
          name: "createWallet",
          component: resolve =>
            require(["@/components/web/page/createWallet/create"], resolve) // createWallet
        },
        {
          path: "/importWallet",
          name: "importWallet",
          component: resolve =>
            require(["@/components/web/page/createWallet/import"], resolve) // importWallet
        },
        {
          path: "/saveKeystore",
          name: "saveKeystore",
          component: resolve =>
            require([
              "@/components/web/page/createWallet/savekeystore"
            ], resolve) // saveKeystore
        },
        {
          path: "/backupSure",
          name: "backupSure",
          component: resolve =>
            require(["@/components/web/page/backupWallet/backupSure"], resolve) // backupSure
        },
        {
          path: "/nav",
          // name: 'nav',
          ...
          children: [
            {
              path: "/",
              component: resolve =>
                require(["@/components/web/page/myAssets/index"], resolve) // myAssets
            },
            {
              path: "/MyAssets",
              name: "MyAssets",
              ...
              children: [
                {
                  path: "/pwdMyAssets",
                  component: resolve =>
                    require(["@/components/web/page/public/pwdSure"], resolve) // pwdSure
                }
              ]
            },
            {
              ...
              // name: 'Transfer',
              component: resolve =>
                require(["@/components/web/page/transfer/index"], resolve), // transfer,
              children: [
                {
                  path: "/",
                  component: resolve =>
                    require(["@/components/web/page/transfer/receive"], resolve) // tranReceive
                },
                {
                ...
                },
                {
                  ...
                  name: "tranSend",
                  component: resolve =>
                    require(["@/components/web/page/transfer/send"], resolve), // tranSend,
                  children: [
                    {
                      path: "/pwdSend",
                      component: resolve =>
                        require([
                          "@/components/web/page/public/pwdSure"
                        ], resolve) // pwdSure
                    }
                  ]
                }
            ...
            },
            {
              ...
              // name: 'LILO',
              component: resolve =>
                require(["@/components/web/page/lilo/index"], resolve), // lilo,
              children: [
                {
                  path: "/",
                  component: resolve =>
                    require(["@/components/web/page/lilo/coinList"], resolve), // coinList,
                  children: [
                    {
                      path: "/pwdCoinList",
                      component: resolve =>
                ...
                },
                {
                  ...
                  // name: 'lockNav',
                  component: resolve =>
                    require(["@/components/web/page/lilo/lockNav"], resolve), // lockNav,
                  children: [
                    {
                      path: "/",
                      component: resolve =>
                        require(["@/components/web/page/lilo/lockIn"], resolve) // lockIn
                    },
                    {
                      path: "/LILO/lockIn",
                      name: "lockIn",
                    ...
                    },
                    {
                      ...
                      component: resolve =>
                        require([
                          "@/components/web/page/lilo/lockOut"
                        ], resolve), // lockOut,
                      children: [
                        {
                          path: "/pwdLockOut",
            ...
            },
            {
              ...
              name: "DAPP",
              component: resolve =>
                require(["@/components/web/page/dapp/index"], resolve) // dapp
            },
            {
              path: "/backupWallet",
              name: "backupWallet",
              component: resolve =>
                require(["@/components/web/page/backupWallet/index"], resolve) // backupWallet
            },
            {
              path: "/loading",
              name: "loading",
              component: resolve =>
                require(["@/components/web/page/public/loading"], resolve) // loading
            }
          ]
        }
      ]
